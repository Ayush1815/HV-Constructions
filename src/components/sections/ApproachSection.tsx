...
export function ApproachSection() {
  return (
    <section id="approach" className="relative overflow-hidden border-t border-[var(--border-soft)] py-16 sm:py-20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeader
          eyebrow="Our approach to every project"
          title="PLAN. BUILD. DELIVER."
          text="A systematic approach that ensures quality, safety, and timely delivery across all our construction and infrastructure projects."
          align="center"
        />
